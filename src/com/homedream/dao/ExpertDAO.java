...
public class ExpertDAO {
	...
	private ExpertDAO() {}
	public void dataInsert(Connection conn, ExpertDTO dto) throws SQLException {
	...
	public List<ExpertDTO> getList(Connection conn,int currpage , int pagepercount ,String search) throws SQLException {
	...
	public ExpertDTO getSelect(Connection conn, int no) throws SQLException {
		PreparedStatement pstmt = null;
		StringBuilder sql = new StringBuilder();
		sql.append("   select                                               ");
		sql.append("                             no                         ");
	...
	public void dataUpdate(Connection conn, ExpertDTO dto)throws SQLException {
		// TODO Auto-generated method stub
		PreparedStatement pstmt = null;
		StringBuilder sql = new StringBuilder();
