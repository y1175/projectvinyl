...
public class AdminBoardAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<BoardDTO> list = service.getList(startrow, endrow, search, txtsearch);// 이건 걍 전체 가져오는거고(페이징으로)
		...
		f.setUrl("/communityadminmain.jsp?page=_member/adminboard.jsp");//list.jsp로 넘김. 근데 얜 왜 jsp인지 모르겟음. 슬래시
																				// 써야함
