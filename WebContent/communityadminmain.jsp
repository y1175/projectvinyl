...
<body>
  <div class="container">
     ...
     <section>
       <c:set var="admin_community_contentpage" value="${param.page}"/>
          <c:if test="${admin_community_contentpage!=null}">
           <jsp:include page="${admin_community_contentpage}"></jsp:include>
          </c:if>
          <c:if test="${admin_community_contentpage==null}">
           <jsp:include page="expertManagerlist.jsp"></jsp:include>
          </c:if>
     </section>
     <footer>
