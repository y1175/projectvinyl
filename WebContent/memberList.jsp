...
<div class="container">
 ...
 <div class="all">
 <ul><li>
<img src="http://localhost:9080/projectvinyl/member/user.png" alt="user"
 class="userimage"><h3>회원조회</h3></li>
 </ul>
...
class="txtsearch" placeholder="회원 정보를 검색해보세요">
...
<tbody>
	...
	<td>
	 ...
	 data-whatever="${item.memNo }" id="orderbutton">${item.point }포인트</button></td>
	<td> 
	<a class="btn btn-outline-secondary" href="delete.do?memNo=${item.memNo}" onclick="delconfirm();">삭제</a>
	<%-- <a href="delete.do?memNo=${item.memNo}" onclick="delconfirm();">삭제</a> --%></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">	
           <ul>
          <li>
            <label for="recipient-name" class="control-label" >회원번호:</label>
            <input type="text" class="form-control" id="recipient-name" name="what"></li></ul>
          </div>
       </div>
...
<c:forEach var="i" begin="${starblock }+1" end="${endblock }" step="1">
	<c:if test="${currpage==i }">
	 <button type="button" class="btn btn-default"
	  onclick="location.href='list.do?curr=${i }&search=${search}&txtsearch=${txtsearch }'">${i }</button>
	<%-- <c:out value="${i }"/> --%>
