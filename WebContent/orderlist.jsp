...
<div class="accordion" id="accordion1">
  <div class="card">
    ...
    <h5 class="_accordion-inside-title">주문 내역</h5>
<div class="_orderguide">
<ul>
<br>
...
<td><a href="orderdetail.do?num=${item.order_no }" class="btn btn-outline-primary">상세보기</a></td>
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="memberInfo" data-parent="#accordion1">
      <div class="card-body">
       ...
       <h5 class="_accordion-inside-title">회원 정보</h5>
<table class="table table-hover">
<tr><th>아이디</th>
...
<div class="_modifybtn">
<a href="modify.do" class="btn btn-outline-primary">회원정보 수정</a><br>
    </div>   
