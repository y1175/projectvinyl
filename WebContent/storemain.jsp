...
<body>
  <div class="container">
     ...
     <section>
      <c:set var="user_store_contentpage" value="${param.page}"/>
        <c:if test="${user_store_contentpage!=null}">
         <jsp:include page="${user_store_contentpage}"></jsp:include>
        </c:if>
        <c:if test="${user_store_contentpage==null}">
         <jsp:include page="storecontent.jsp"></jsp:include>
        </c:if>
     </section>
     <footer>
