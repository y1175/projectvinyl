...
<link rel="stylesheet" href="css/_joinform.css">
</head>
<body>
			...
			new daum.Postcode(
					{
						oncomplete : function(data) {
							...
							document.getElementBd('sample4_postcode').value = data.zonecode; //5자리 새우편번호 사용
							document.getElementBd('sample4_roadAddress').value = fullRoadAddr;
							document.getElementBd('sample4_jibunAddress').value = data.jibunAddress;
							...
							if (data.autoRoadAddress) {
								...
								var expRoadAddr = data.autoRoadAddress
										+ extraRoadAddr;
								//document.getElementBd('guide').innerHTML = '(예상 도로명 주소 : ' + expRoadAddr + ')';
								document.getElementBd('sample4_roadAddress').value = expRoadAddr;
							} else if (data.autoJibunAddress) {
								var expJibunAddr = data.autoJibunAddress;
								//document.getElementBd('guide').innerHTML = '(예상 지번 주소 : ' + expJibunAddr + ')';
								document.getElementBd('sample4_jibunAddress').value = expJibunAddr;
							} else {
								document.getElementBd('guide').innerHTML = '';
							}
						}
					}).open();
		}
