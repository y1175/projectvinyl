...
<link rel="stylesheet" href="css/_adminboard.css">
<style>
	#imgblock{
		width: 100px;
		height:100px;
...
<body>
		...
		<div class="_backToOrderlist">
			<a href="orderlist.do">주문내역으로 돌아가기</a>
		</div>
		<h4 class="_orderdetailTitle">주문 상세정보</h4>
		<br>

		<h5 class="_orderdetail-location">주문/배송지 정보</h5>
		<div class='row'>
			<div class='col-1'></div>
			<div class='col-7'>
				<table class="table">
		...
		<br>
		<h5 class="_orderdetail-item">주문상품</h5>
		<div class='row'>
			<div class='col-1'></div>
			<div class='col-10'>
				<table class="table">
		...
		<div class='_ordercancelbtn'>
			<a href="ordercancel.do?num=${order[0].order_no }"
