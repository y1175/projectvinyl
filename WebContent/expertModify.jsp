...
<!-- jQuery -->
<link rel ="stylesheet" href="css/modify.css?ver=2">
...
<form method = "post" action="uploadresult.do" enctype="multipart/form-data">
		...
		<div class="input-group flex-nowrap" style="margin : 30px auto 30px; width:80%;">
			...
			<ul>
				...
				<input type="reset" value="취소" onclick="location.href='managerdetail.do?no=${dto.no}'">
