...
<body>
  <div class="container">
     ...
     <section>
     <c:set var="user_community_contentpage" value="${param.page}"/>
       <c:if test="${user_community_contentpage!=null}">
         <jsp:include page="${user_community_contentpage}"></jsp:include>
       </c:if>
       <c:if test="${user_community_contentpage==null}">
         <jsp:include page="communitycontent.jsp"></jsp:include>
       </c:if>
